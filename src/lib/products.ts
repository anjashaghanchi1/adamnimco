// Product images
import bhailDry from "@/assets/products/bhail-dry.jpg";
...
export const PRODUCTS: Product[] = [
  ...
  {
    slug: "bhail-puri-dry",
    name: "Bhail Puri (Dry Chatni)",
    short: "Tangy chaat with dry chutney mix",
    description:
      "Our signature bhail puri — puffed rice with crispy sev, fresh onions, tomatoes and our special dry chutney blend. Made fresh daily.",
    image: bhailDry,
    variants: scaled(250, 350, "250g"),
    badges: ["⭐ Signature"],
    category: "bhail-puri",
    special: true,
  },
